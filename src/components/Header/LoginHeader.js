      ...
      <Row>
        <Col md={6} >
          <ul className='topbar-list'> 
            <li>
              <span><i className="fa fa-phone"> </i> <a>Tel: 042-111-222-500</a></span>
            </li>
            <li>
               <span><i className="fa fa-envelope"> </i> <a href="mailto:info@sabsaath.org">info@sabsaath.org</a></span>
             </li>
          </ul>
        </Col>
        ...
        <Col md={6}>
          <ul className='top-social-icons'>
            ...
            <li ><a href="https://www.facebook.com/SabSaath.org/" target="_blank" rel="noreferrer"><i className='fa fa-facebook'></i></a></li>
            <li ><a href="https://instagram.com/sabsaathpk?utm_medium=copy_link" target="_blank" rel="noreferrer"><i className='fa fa-instagram'></i></a></li>
            <li><a href="https://www.linkedin.com/company/zamanfoundation/ " target="_blank" rel="noreferrer"><i className='fa fa-linkedin'></i></a></li>
          ...
          >
            ...
            <li className="nav-item">
              <a className="nav-link login-btn" href="/login">
                <span className="d-md-block">{localStorage.getItem("Name") === null ? "Login": localStorage.getItem("Name")}</span>
              </a>
            </li>
            <li className="nav-item">
              ...
              <>
              <Link className="nav-link register-btn" onClick={(e) => funLogOut(e)} href='#'>
            ...
            <li className="nav-item">
             ...
             ""
              ...
              <>
               <Link className="nav-link register-btn" to="/Login">
                <span className="d-md-block">Reset</span>
              </Link>
              </>
              )}
            </li>
