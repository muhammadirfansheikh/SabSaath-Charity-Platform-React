...
import ModalImpactStrip from "components/modal/ModalImpactStrip"

const ImpactStripModule = (props) => {
  var UserId = localStorage.getItem("UserId")
  var UserIp = localStorage.getItem("UserIP")
  const initialValues = {
    ActiveModule: "",
  }
  const GetImpactStrips = async () => {
    try {
  ...
  let [loading, data, error] = useApiCallOnMount(GetImpactStrips, refresh)
  ...
  const ReBindGrid = async () => {
    ...
    const res = await GetImpactStrips()
    setAds(res)
  }
...
export default ImpactStripModule
