...
const Report_Payment_Reverse_Disburs = (props) => {
    ...
    const resetFormelement = async () => {
        ...
        let ddlstatus = await GetStatus();
        setstatusddl(ddlstatus.data);
    ...
    const GetStatus = async (e) => {
        var data = await GetSetupMaster(SetupMasterIds.PaymentStatus, 0, "", 0);
        return data;
    }
    ...
    const handlePaymentStatus = async (e) => {
        ...
        handleInputChange(e);
        let Statusddl1 = await GetStatus(e.target.value);

        setstatusddl(Statusddl1.data);
    ...
    const GetPaymentListReport = async () => {
     ...
     //     
            ...
            searchValues.PaymentStatus = searchValues.PaymentStatus == -1 ? null : searchValues.PaymentStatus;
            ...
            const data = await fetchData(
                ...
                ApiMethods.Report_Payment_Reverse_Disburs,
                searchValues
            ); 
            if (data != null) {
                    ...
                    <Col lg={12} md={12}>
                        <Card>
                            <CardHeader>
                                <Row>
                                    <Col lg={6} md={6}>
                                        Report Payment Disburse / Reverse
                                    </Col>
...
export default Report_Payment_Reverse_Disburs