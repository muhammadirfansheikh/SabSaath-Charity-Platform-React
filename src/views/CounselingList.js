        ...
        <CardBody>
          <Form>
            ...
            <Row form>
              <Col md={3}>
                <FormGroup>
                  <Label for="">Counsellor Name</Label>
                  <Input type="text" className="form-control" />
                </FormGroup>
              </Col>
              <Col md={3}>
                <FormGroup>
                  <Label for="">Counsellor Contact Number</Label>
                  <Input type="number" className="form-control" />
                </FormGroup>
              </Col>
              <Col md={3}>
                <FormGroup>
                  <Label for="">Date of Counselling</Label>
                  <Input type="date" className="form-control" />
                </FormGroup>
              </Col>
              <Col md={3}>
                <FormGroup>
                  <Label for="">Next Counselling Date</Label>
                  <Input type="date" className="form-control" />
                </FormGroup>
              </Col>
            </Row>
                ...
                <FormGroup>
                  <div className="form-check-inline mt-3 pt-3">
                    <Label className="form-check-Label">
                      ...
                      Parents/Guardians present during counselling
                    </Label>
                  </div>
                </FormGroup>
              </Col>
          ...
          <Row>
            <Col md={12}>
              <h2 className="h6">Counselling List</h2>
            </Col>
          </Row>
          <Row>
            <Col md={12}>
              <Table bordered striped responsive>
                <thead>
                  <tr>
                    ...
                    <th>Counsellor Contact Number</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td></td>
                    <td>
                    <a href="#" color="primary2" className="m-0" onClick={OpenCouncellingPage} >Counselling</a>
                    </td>
                  </tr>
                  <tr>
                    <td>2</td>
